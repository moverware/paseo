...
| Model and effort mirroring            | the external process's model and effort are read from its transcript (effort from the `effort` stamp on assistant entries and `/effort` output) and announced as `model_changed` / `thinking_option_changed`; an effort chosen on the phone goes to the pane as `/effort`                                                                                                                                                                                                   |
